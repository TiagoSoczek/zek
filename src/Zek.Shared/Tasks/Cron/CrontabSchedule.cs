...
namespace Zek.Shared.Tasks.Cron
{
    ...
    public sealed class CrontabSchedule
    {
        ...
        private CrontabSchedule(string expression)
        {
            ...
            if (fields.Length != 5)
                throw new FormatException($"'{expression}' is not a valid crontab expression. " +
                                          "It must contain at least 5 components of a schedule (in the sequence of minutes, hours, days, months, days of week).");
